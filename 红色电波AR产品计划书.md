...
**空间目标**：营造隐蔽、克制、紧张但可清晰参观的虚拟通信展馆。以 1943 年冬涧沟村山洞秘密电台与农家掩护关系为物理叙事核心，以明显的展馆信息层呈现 1945 年交通线和 1947 年清风店战役结果。建议体验空间约 8 m × 8 m；该尺寸是产品白盒尺度，不是历史测绘尺寸。使用暖色低照度主光，桌面和电台区域有明确引导光，不使用过强烟雾或全屏暗角。
...
|---|---|---|---|---|
| `env_s1_room` | 隐蔽通信主题环境 | MVP | 原创灰砖/木构地域入口意象 + 山洞或夯土感操作区 + 现代信息层；不复制现纪念馆，不宣称 1:1 | 提供外边界和主要障碍物碰撞盒 |
| `p_s1_radio` | 秘密电台（场景化复原） | MVP | 独立 GLB；只做无品牌、无编号的通用箱式设备，馆方确认型号前禁止补真实铭文和精确制式 | 点击打开介绍并播放讲解 |
...
**动作**：制作 8 m × 8 m 左右白盒，放置起点、桌面、电台、发报键、无铭文“电文与保密通信资料包”占位、墙体和碰撞参考。8 m × 8 m 是体验尺度，不作历史尺寸声明。
