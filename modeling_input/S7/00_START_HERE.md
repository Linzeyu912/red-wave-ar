...
> 状态：`VISUAL_INPUT_RECEIVED / VISUAL_CONSTRAINTS_IMPLEMENTED_V1 / SINGLE_VIEW_ACCEPTED / MODEL_V2_BUILT / PRIMARY_SIGNAGE_STATE_SELECTED / NARRATION_PENDING / RIGHTS_PENDING`
> 导入日期：2026-07-27
...
当前受控目录共有 7 个文件。S7A 的触发图为 `trigger_hand_drawn.jpg`，主要真实照片为 `d10d05331791c52d672efca4212a9012.png`，当前模型为 `S7A_telecom_museum_v002.glb`。正式文字资料仍待负责同学补充。
