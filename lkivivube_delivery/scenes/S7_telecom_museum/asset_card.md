...
> 状态：`MODEL_V3_DETAIL_STATIC_GROUND_V002_READY / NARRATION_USER_AUDIO_V003_SELECTED_READY_FOR_IMPORT / BLENDER_5_1_2_REVIEWED / LOCAL_VALIDATION_PASS / PRIMARY_SIGNAGE_STATE_SELECTED / RIGHTS_PENDING / PLATFORM_UPLOAD_PENDING`
...
- 介绍音频：用户明确指定的源音频已校验；Kivicube 上传文件为 `kivicube_package/S7A_telecom_museum/S7A_telecom_museum_narration_v003.m4a`。
