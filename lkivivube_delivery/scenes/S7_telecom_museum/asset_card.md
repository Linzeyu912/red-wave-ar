...
> 状态：`MODEL_V1_BUILT / BLENDER_5_1_2_REVIEWED / LOCAL_VALIDATION_PASS / PRIMARY_SIGNAGE_STATE_SELECTED / NARRATION_PENDING / RIGHTS_PENDING / PLATFORM_UPLOAD_PENDING`
...
- V1 采用主要照片和手绘触发图共同出现的“高塔带竖向中国电信博物馆馆名”状态；没有混入无标识状态的冲突细节。该贴花在 `.blend` 中仍可替换。核验依据：[`../../../modeling_input/SUBJECT_IDENTITY_VERIFICATION.md`](../../../modeling_input/SUBJECT_IDENTITY_VERIFICATION.md)。
- GLB：`model/S7A_telecom_museum_v001.glb`，129,240 B、5 网格、1,304 三角面、5 材质、1 贴图；本地预算与 Blender 5.1.2 回读检查通过。
- 可编辑源文件：`../../source/blend/S7A_telecom_museum_v001_source.blend`。
- V1 预览：`images/S7A_telecom_museum_preview_v001.png`。
