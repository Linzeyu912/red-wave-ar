...
- GLB：`model/S6A_zhenfang_lou_v003.glb`，881,804 B、5 网格、13,082 三角面、5 材质、0 贴图、保留 1 个历史 `photo_emerge` 动画但 V002 流程不播放；已细化五开间灰砖缝、方柱、十扇细分拱门窗、密栏杆、漏空檐带和中央山花。入口改为照片对应的 6 级浅台阶，总高约 0.51 m，保持外低内高并完整露出中央门；本地预算与 Blender 5.1.2 回读检查通过。
