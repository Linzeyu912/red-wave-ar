...
- GLB：`model/S6A_zhenfang_lou_v003.glb`，515,552 B、5 网格、7,658 三角面、5 材质、0 贴图、1 个 `photo_emerge` 动画；已细化五开间、方形灰砖柱、拱门窗、环廊栏杆、漏空檐带和中央山花，并纠正入口台阶为外低内高；本地预算与 Blender 5.1.2 回读检查通过。
