...
> 状态：`MODEL_V1_BUILT / BLENDER_5_1_2_REVIEWED / LOCAL_VALIDATION_PASS / NARRATION_PENDING / DISPLAY_PHOTO_BLOCKED / PLATFORM_UPLOAD_PENDING`
...
- GLB：`model/S5A_memorial_sculpture_v001.glb`，300,856 B、4 网格、4,246 三角面、4 材质、1 贴图；本地预算与 Blender 5.1.2 回读检查通过。
- 可编辑源文件：`../../source/blend/S5A_memorial_sculpture_v001_source.blend`。
- V1 预览：`images/S5A_memorial_sculpture_preview_v001.png`。
