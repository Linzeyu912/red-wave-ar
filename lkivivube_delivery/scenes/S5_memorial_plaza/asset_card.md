...
> 状态：`MODEL_V2_PHOTO_PLANE_BUILT / BLENDER_5_1_2_REVIEWED / LOCAL_VALIDATION_PASS / NARRATION_PENDING / DISPLAY_PHOTO_BLOCKED / PLATFORM_UPLOAD_PENDING`
...
- GLB：`model/S5A_memorial_sculpture_v002.glb`，301,792 B、4 网格、4,246 三角面、4 材质、1 贴图、1 个 `photo_emerge` 动画；本地预算与 Blender 5.1.2 回读检查通过。
- 可编辑源文件：`../../source/blend/S5A_memorial_sculpture_v002_source.blend`。
- V2 预览：`images/S5A_memorial_sculpture_preview_v002.png`。
