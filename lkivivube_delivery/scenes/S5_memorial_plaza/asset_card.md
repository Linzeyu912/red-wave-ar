...
> 状态：`MODEL_V3_DETAIL_STATIC_GROUND_V002_READY / NARRATION_USER_AUDIO_V003_SELECTED_READY_FOR_IMPORT / BLENDER_5_1_2_REVIEWED / LOCAL_VALIDATION_PASS / REFERENCE_SOURCE_REVIEW_PENDING / PLATFORM_UPLOAD_PENDING`
...
- GLB：`model/S5A_memorial_sculpture_v003.glb`，1,339,648 B、5 网格、45,564 三角面、5 材质、1 贴图、保留 1 个历史 `photo_emerge` 动画但 V002 流程不播放；保留五折浮雕墙、群像变化和《家国》铜牌，铜牌标题采用接近碑刻的隶书并保持传统右起字序；四尊前景人物从球柱体升级为连续头脸、发型、收分肢体、分离手掌/手指与四种差异姿态。本地预算与 Blender 5.1.2 回读检查通过。
...
- 介绍音频：用户明确指定的源音频已校验；Kivicube 上传文件为 `kivicube_package/S5A_memorial_sculpture/S5A_memorial_sculpture_narration_v003.m4a`。
