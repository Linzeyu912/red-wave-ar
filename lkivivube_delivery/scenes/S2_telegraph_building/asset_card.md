...
- GLB：`model/S2A_telegraph_building_v003.glb`，683,364 B、5 网格、9,836 三角面、5 材质、0 贴图、1 个 `photo_emerge` 动画；已细化上下层窗格、中央入口、横向檐带和钟塔格栅，并纠正入口台阶为外低内高；本地预算与 Blender 5.1.2 回读检查通过。
