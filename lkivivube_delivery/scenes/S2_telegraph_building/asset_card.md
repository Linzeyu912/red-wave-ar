...
> 状态：`MODEL_V1_BUILT / BLENDER_5_1_2_REVIEWED / LOCAL_VALIDATION_PASS / NARRATION_PENDING / RIGHTS_PENDING / PLATFORM_UPLOAD_PENDING`
...
- GLB：`model/S2A_telegraph_building_v001.glb`，119,008 B、5 网格、1,712 三角面、5 材质、0 贴图；本地预算与 Blender 5.1.2 回读检查通过。
- 可编辑源文件：`../../source/blend/S2A_telegraph_building_v001_source.blend`。
- V1 预览：`images/S2A_telegraph_building_preview_v001.png`。
