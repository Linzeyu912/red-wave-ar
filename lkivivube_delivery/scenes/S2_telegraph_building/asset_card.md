...
- GLB：`model/S2A_telegraph_building_v002.glb`，119,948 B、5 网格、1,712 三角面、5 材质、0 贴图、1 个 `photo_emerge` 动画；本地预算与 Blender 5.1.2 回读检查通过。
- 可编辑源文件：`../../source/blend/S2A_telegraph_building_v002_source.blend`。
- V2 预览：`images/S2A_telegraph_building_preview_v002.png`。
