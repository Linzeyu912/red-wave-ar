...
> 状态：`NINE_MODELS_V1_BUILT / BLENDER_5_1_2_REVIEWED / LOCAL_VALIDATION_PASS / PLATFORM_UPLOAD_PENDING`
...
九个模型均已生成 GLB，经 Blender 5.1.2 实际导入、保存可编辑 `.blend` 并渲染预览；GLB 结构和 Kivicube 本地预算检查全部通过。生成方法、总览图和机器可读报告见 [`source/README.md`](source/README.md)。

| 单元 | 模型 | 大小 | 网格 | 三角面 | 材质 | 贴图 |
|---|---|---:|---:|---:|---:|---:|
| S1A | 平西情报联络站入口门楼 | 250,292 B | 5 | 1,864 | 5 | 1 |
| S1B | 女报务员雕塑及发报设备 | 93,696 B | 3 | 1,392 | 3 | 0 |
| S2A | 电报大楼 | 119,008 B | 5 | 1,712 | 5 | 0 |
| S3A | 通信楼 | 133,304 B | 4 | 2,124 | 4 | 0 |
| S3B | 天线阵列 | 313,160 B | 3 | 4,876 | 3 | 0 |
| S4A | 居庸关城楼 | 103,832 B | 5 | 1,172 | 5 | 1 |
| S5A | 西山无名英雄纪念广场雕塑群 | 300,856 B | 4 | 4,246 | 4 | 1 |
| S6A | 香山镇芳楼 | 103,524 B | 5 | 1,490 | 5 | 0 |
| S7A | 中国电信博物馆 | 129,240 B | 5 | 1,304 | 5 | 1 |
